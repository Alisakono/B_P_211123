package org.example.src.lesson20240417;
...
public class StreamExamples {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> integerResult = integerList.stream().filter(i -> i % 2 == 0)
                .peek(System.out::println).sorted().toList();
        ...
        List<Employee> employees = Stream.of("Ivan", "John", "Mary", "Jenny")
                .map(name -> new Employee(name, "Surname", 24, 40)).toList();
