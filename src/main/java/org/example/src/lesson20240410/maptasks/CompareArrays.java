package org.example.src.lesson20240410.maptasks;
...
public class CompareArrays {
    ...
    public static boolean isEqualDataWithHashTable(int[] array1, int[] array2) { // O(n)
...
//        return true;
    ...
    public static boolean isEqualDataBySort(int[] array1, int[] array2) { // O (n log n)
