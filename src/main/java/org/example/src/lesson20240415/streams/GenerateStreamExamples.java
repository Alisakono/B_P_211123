package org.example.src.lesson20240415.streams;
...
public class GenerateStreamExamples {
    ...
    public static void main(String[] args) {
        ...
        Stream<Integer> integerStream4 = integerStream3.peek(integer -> System.out.println("Looking up: " + integer)); // intermediate operation
...
//        integerStream3.toList(); // stream is already closed
